...
class Network:
    ...
    def construct(self, args, num_words, num_chars, num_tags):
        ...
        with self.session.graph.as_default():
            ...
            rnn_outputs, _ = tf.nn.bidirectional_dynamic_rnn(fw_cell, bw_cell, words_embedded, sequence_length=self.sentence_lens, dtype=tf.float32, scope="BLSTM1")
            ...
            rnn_output = tf.concat(rnn_outputs, axis=2, name="concat_rnn_outputs_2")
